...
void countApplesAndOranges(int s, int t, int a, int b, vector<int> apples, vector<int> oranges) {
    //Resulting locations of falling apples.
    for (int i = 0; i < apples.size(); ++i) {
        apples[i] += a;
    }
    
    //Resulting locations of falling oranges.
    for (int i = 0; i < oranges.size(); ++i) {
        oranges[i] += b;
    }
    
    //Counters for the number of apples and oranges.
    int numApples = 0;
    int numOranges = 0;
    
    //Calculate the number of apples that may have fallen on the house.
    for (int i = 0; i < apples.size(); ++i) {
    ...
    //Calculate the number of oranges that may have fallen on the house.
    for (int i = 0; i < oranges.size(); ++i) {
    ...
    //Output the number of apples and oranges.
